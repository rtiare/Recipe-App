...
export const recipesList = [
  ...
  },    
  {
    ...
    ingredients: [
      ...
      {key: '2 tsp Salt'},
      {key: '1/4 tsp Black Pepper'},
      {key: '1/8 tsp Garlic Powder'},
      {key: '1/2 tsp MSG'},
  ...
  },
  {
    ...
    description:
      '-- In a medium pot over medium heat, heat 1 Tbsp oil. Add onion and cook until soft, 5 minutes. Add garlic and cook until fragrant, 1 minute more. Add tomato paste and stir to coat onion and garlic. Add ground beef and cook, breaking up meat with a wooden spoon, until no longer pink, 6 minutes. Drain fat.\n\n -- Return beef to pot and season with chili powder, paprika, salt, and pepper. Add tomato sauce and kidney beans. Bring to a boil, then reduce heat and let simmer 15 minutes. Add some chili to center of each tortilla, leaving room to fold in edges. Top with Fritos, then cheddar. Fold edges of tortillas toward the center, creating pleats. Invert Crunchwraps so pleats are on the bottom and stay together.\n\n -- In medium skillet over medium heat, heat remaining Tbsp oil. Add a Crunchwrap seam side down and cook until tortilla is golden, 3 to 5 minutes per side. Repeat with remaining Crunchwraps'
  },
  {
    recipeId: 3,
    categoryId: 3,
    ...
    ingredients: [
      ...
      {key: '1/2 tsp Celery Salt'},
      {key: '1/2 tsp Dried Sage'},
      {key: '1/2 tsp Garlic Powder'},
      {key: '1/2 tsp Ground Allspice'},
      {key: '1/2 tsp Dried Oregano'},
      {key: '1/2 tsp Dried Basil'},
      {key: '1/2 tsp Dried Marjoram'},
      {key: '1/2 cups All Purpose Flour'},
  ...
  },
  {
    ...
    ingredients: [
      ...
      {key: '3 Tbsp Oil'},
      {key: '1 tsp Paprika'},
      {key: '1/2 tsp Ground Cumin'},
      {key: '1/2 tsp Cayenne Pepper'},
      {key: '2 tsp Black Pepper'},
      {key: '1/2 lb Flaky White Fish'},
      {key: '8 Large Tortillas'},
  ...
  },
  {
    ...
    ingredients: [
      ...
      {key: '1/2 tsp Chilli Powder'},
      {key: '1/2 tsp Paprika'},
      {key: '1 pound Chicken Breast'},
      {key: '1/2 cup Onion, Chopped'},
      {key: '6 Large Tortillas'},
      {key: '4 Onions'},
      {key: '1/2 Green Pepper'},
      {key: '1/2 Red Pepper'}
    ],
    description:
      '-- In a large bowl, combine 2 Tbsp oil, lemon juice and seasonings; add the chicken. Turn to coat; cover. Refrigerate for 1-4 hours In a large skillet, saute peppers and onions in remaining oil until crisp-tender. Remove and keep warm. Drain chicken, discarding marinade. In the same skillet, cook chicken over medium-high heat for 5-6 minutes or until no longer pink.\n\n -- Return pepper mixture to pan; heat through. Spoon filling down the center of tortillas; fold in half. Serve with toppings as desired.'
  },
  {
    recipeId: 6,
    categoryId: 0,
    ...
    time: 50,
    ingredients: [
      {key: '1 lb Pizza Dough'},
      {key: '1 cup Ketchup'},
      {key: '1/2 cup Hot Sauce'},
      {key: '1/4 cup Butter'},
      {key: '2 Tbsp Heavy Cream'},
      {key: '1/2 cup Whole Milk Plain Yogurt'},
      {key: '1/4 tsp Garlic Powder'},
      {key: '1/4 tsp Celery Salt'},
      {key: '1/4 tsp Lime Juice'},
      {key: '2 oz Cheese'},
      {key: 'All Purpose Floue (For Dusting)'},
      {key: '1/2 tsp Black Pepper'},
      {key: '2 Celery Stalks'},
      {key: '9 oz Mozzarella'}
    ],
    description:
  ...
  },
  {
    ...
    ingredients: [
      ...
      {key: '1 lb Ground Beef'},
      {key: '5 Garlic Cloves'},
      {key: '1 pound Lasagna Noodles'},
      {key: '1 pound Italian Sauce'},
      {key: '28 oz Crushed Tomatoes'},
      {key: '12 oz Tomato Paste'},
      {key: '2 Tbsp Sugar'},
      {key: '1/4 cup Fresh Parsley, Minced'},
      {key: '1/2 cup Dried Basil'},
      {key: '1/2 tsp Salt'},
      {key: '1 tsp Fennel Seeds'},
      {key: '1/4 tsp Black Pepper'},
      {key: '1 large Egg'},
      {key: '1 pound Mozzarella'},
      {key: '1 cup Parmesan Cheese'},
      {key: '30 oz Ricotta Cheese'}
    ],
    description:
      '-- Cook noodles according to package directions; drain. Meanwhile, in a Dutch oven, cook sausage, beef and onion over medium heat 8-10 minutes or until meat is no longer pink, breaking up meat into crumbles. Add garlic; cook 1 minute. Drain. Stir in tomatoes, tomato paste, water, sugar, 3 Tbsp parsley, basil, fennel, 1/2 tsp salt and pepper; bring to a boil. Reduce heat; simmer, uncovered, 30 minutes, stirring occasionally. In a small bowl, mix egg, ricotta cheese, and remaining parsley and salt. Preheat oven to 375°. Spread 2 cups meat sauce into an ungreased 13x9-in. baking dish. Layer with 3 noodles and a third of the ricotta mixture. Sprinkle with 1 cup mozzarella cheese and 2 Tbsp Parmesan cheese.\n\n -- Repeat layers twice. Top with remaining meat sauce and cheeses (dish will be full). Bake, covered, 25 minutes. Bake, uncovered, 25 minutes longer or until bubbly. Let stand 15 minutes before serving.'
  },
  {
    recipeId: 10,
    categoryId: 4,
    ...
    ingredients: [
      {key: '1 Banana'},
      {key: '1/2 lb Frozen Straberries'},
      {key: '1/2 liter Greek Yogurt'},
    ],
